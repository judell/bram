...
// "judell opened about 9 hours ago" — and is exactly what overflowed the
// fixed-width cell. maxLines alone would have rendered "less than a…", the
// same length problem with the information removed.
